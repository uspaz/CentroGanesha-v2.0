  ...
  return (
    <>
      <header className="w-full h-[100px] md:rounded-full bg-[#2D331E] flex items-center justify-center">
        ...
        {showMenu ? (
          <IoClose
            className="absolute top-5 left-5 text-white z-50 cursor-pointer"
            size={30}
        ...
        <nav
          ...
          } w-full h-screen absolute top-0 left-0 flex  items-center font-bai bg-[#1D331e] text-white text-xl transition-all duration-500 z-10`}
        >
